...
1. Keep the sanitized `public-search-download-proof` and `rust-webui-live-proof`
   harnesses on the regular daemon path as the current download/search and
   embedded WebUI gates.
