...
rollback is simple. For controlled testing, launch with an explicit disposable
profile:
...
Use this section when you want to verify or customize the full
suite/bootstrapper flow instead of only running the one-liner.
