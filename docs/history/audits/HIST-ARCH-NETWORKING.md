...
- [2. Async I/O Model — Shared WSAPoll Backend](#2-async-io-model-shared-wsapoll-backend)
- [3. TCP Packet Framing and Reassembly — CEMSocket](#3-tcp-packet-framing-and-reassembly-cemsocket)
- [4. Encryption Transport — CEncryptedStreamSocket](#4-encryption-transport-cencryptedstreamsocket)
- [5. Proxy Support (Removed)](#5-proxy-support-removed)
- [6. Upload Bandwidth Throttler](#6-upload-bandwidth-throttler)
- [7. UPnP — Port Mapping Architecture](#7-upnp-port-mapping-architecture)
- [8. UDP Sockets](#8-udp-sockets)
- [9. Server Connection State Machine — CServerConnect](#9-server-connection-state-machine-cserverconnect)
- [10. Connection Acceptance — CListenSocket](#10-connection-acceptance-clistensocket)
- [11. Thread Model and Synchronization](#11-thread-model-and-synchronization)
- [12. Network Error Handling](#12-network-error-handling)
- [13. Performance Characteristics](#13-performance-characteristics)
- [14. Issues and Recommendations](#14-issues-and-recommendations)
- [15. Component Reference Table](#15-component-reference-table)
- [Future: IPv6, uTP, and NAT Traversal](#future-ipv6-utp-and-nat-traversal-from-emuleai-analysis)
