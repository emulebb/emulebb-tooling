...
created: 2026-04-10
updated: 2026-05-24
source: stale-v0.72a-experimental-clean, commit 810c3c7; current `main` commit `aa031be`
---
...
- app commit `aa031be` — `REF-030 replace download source async DNS`
...
- [ ] IPv6 address results handled (deferred to the IPv6 roadmap rather than
      required for the current IPv4 source path)
