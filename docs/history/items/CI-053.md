...
- [x] Re-run `Controlled Smoke` (`workflow_dispatch`) and confirm the
      `arm64_smoke` job builds + smokes green on `windows-11-arm` — **PASSED**,
      run `27343000884` (2026-06-11): all jobs success incl.
      `Package and smoke (ARM64, windows-11-arm)`.
