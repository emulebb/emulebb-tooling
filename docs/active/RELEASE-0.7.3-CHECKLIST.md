...
assets are still generated by the GitHub release workflows with
...
- [ ] `python -m emule_workspace package-release --config Release --platform x64 --release-version 0.7.3`
- [ ] `python -m emule_workspace package-release --config Release --platform ARM64 --release-version 0.7.3`
- [ ] `python -m emule_workspace package-amutorrent --config Release --platform x64 --release-version 0.7.3`
