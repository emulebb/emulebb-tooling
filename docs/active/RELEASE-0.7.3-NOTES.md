...
`0.7.3` is the first public eMuleBB release for users who want a
...
Do not treat a nightly, beta, or RC package as the stable `0.7.3` release. The
stable release tag is `emulebb-v0.7.3`.
