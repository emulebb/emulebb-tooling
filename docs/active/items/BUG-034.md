...
id: BUG-034
workflow: github
github_issue: https://github.com/emulebb/emulebb/issues/36
...
> Workflow status is tracked in GitHub: https://github.com/emulebb/emulebb/issues/36. This local document is retained as an engineering spec/evidence record.

# BUG-034 - Release paths silently swallow unexpected exceptions via catch (...) plus ASSERT(0)
...
- `srchybrid/Collection.cpp` still has minor cleanup opportunities around
  signature-buffer staging and raw temporary buffers. Leave this out of release
  scope unless collection maintenance resumes for another reason.
