...
- current required gaps reported by the audit:
  controller-surface evidence, live-wire-release evidence, ui-resource-depth
  evidence, stabilization-stress evidence, and the manual clean-worktree
  packaging-provenance row
