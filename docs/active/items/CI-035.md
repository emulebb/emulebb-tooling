...
- Existing x64, ARM64, and optional aMuTorrent x64 package hashes remain
  non-final because package evidence must be regenerated from the selected
  heads after proof succeeds.
...
- package:
  `workspaces\workspace\state\release\emule-bb-v0.7.3\eMule-broadband-0.7.3-x64.zip`
- manifest:
  `workspaces\workspace\state\release\emule-bb-v0.7.3\eMule-broadband-0.7.3-x64.manifest.json`
- SHA-256:
...
- package:
  `workspaces\workspace\state\release\emule-bb-v0.7.3\eMule-broadband-0.7.3-arm64.zip`
- manifest:
  `workspaces\workspace\state\release\emule-bb-v0.7.3\eMule-broadband-0.7.3-arm64.manifest.json`
- SHA-256:
...
- `python repos\eMule-tooling\ci\check-clean-worktree.py` passed.
...
- The interrupted `ui-resource-depth` process tree was stopped before package
  generation, and no `emule.exe`, `ui-resource-depth`, or `resource-ui-smoke`
...
- [ ] Package paths, SHA-256 hashes, app/build/build-tests/tooling commits,
      optional aMuTorrent commit, certification reports, and child report paths
      are recorded here and in the release checklist.
...
Before final proof resumed, the `eMule-build-tests` harness was hardened for the
