...
Current support decision: IRC and the legacy Scheduler are frozen surfaces. They
receive no support, no new tests, and no release-gated evidence. The preferred
resolution is deletion, not compatibility shims or renewed maintenance. The
broader frozen-surface policy is recorded in
